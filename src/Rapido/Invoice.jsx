        ...
        <div className='main'>
            ...
            <div className="total">
                <div className="column">
                    ...
                    <div className="vericalItem">₹{data.rideCharges+data.bookingFee}</div>
                </div>
            </div>
            ...
            <div className="row addrmap" >
                ...
                <div className="info">
                    <div className="column distance">
                        <div className="vericalItem">{data.distance}</div>
                        <div className="vericalItem">Distance</div>
                    </div>
                    <div className="column duration">
                        <div className="vericalItem">{data.duration}</div>
            ...
            <div className="billdetails">
                <h3 className="heading">Bill Details</h3>
                <div className="column charges">
                    <div className="row">
                        <div>Ride Charge</div>
                        <div>{data.rideCharges}</div>
                    </div>
                    <div className="row">
                        <div>Booking fees & Convenience Charges</div>
                        <div>{data.bookingFee}</div>
                    </div>
                </div>
                ...
                <div className="row">
                    ...
                    <div>₹{data.rideCharges+data.bookingFee}</div>
                </div>
            </div>
            ...
            <div className="paymentmethod row">
                ...
                <div className='pmtotal'>₹{data.rideCharges+data.bookingFee}</div>
            </div>
        </div>
    )
}